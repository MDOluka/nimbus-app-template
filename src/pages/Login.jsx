    ...
    <div className="bg-background min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center px-6">
        <form onSubmit={handleSubmit} className="bg-white p-10 rounded-lg shadow-lg w-full max-w-md space-y-4">
          <h1 className="text-3xl font-heading text-primary text-center">Login</h1>
          ...
          <button type="submit" className="w-full bg-secondary text-white py-3 rounded-lg hover:scale-105 transform transition">Login</button>
        </form>
      </main>
      <Footer />
    </div>
